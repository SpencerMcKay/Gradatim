...
const SEED_ROOT = {
  ...
  children: [{
    ...
    children: [{
      ...
      description: "sees second-order effects, designs from first principles.",
      weight: 35,
      children: [],
      tasks: [{
        id: "t1",
        name: "finish DDIA ch.5–9",
        impact: 8,
        effort: 5,
        done: true
      }, {
        id: "t2",
        name: "redesign storage layer notes",
        impact: 9,
        effort: 6,
        done: false
      }, {
        id: "t3",
        name: "audit own arch vs known patterns",
        impact: 7,
        effort: 4,
        done: false
      }, {
        id: "t4",
        name: "write 'failure modes' essay",
        impact: 8,
        effort: 5,
        done: false
      }]
      ...
      id: "craft.writing",
      name: "writes_clearly",
      description: "leaves a paper trail. communicates compounding ideas.",
      weight: 25,
      children: [],
      tasks: [{
        id: "t5",
        name: "publish 2 internal essays",
        impact: 9,
        effort: 8,
        done: false
      }, {
        ...
        id: "t7",
        name: "rewrite README of main project",
        impact: 7,
        effort: 3,
        done: true
      }]
      ...
      id: "craft.ship",
      name: "ships_things",
      description: "finishes. owns the boring last 20%.",
      weight: 40,
      children: [],
      tasks: [{
        id: "t8",
        name: "release v2 of main project",
        impact: 10,
        effort: 9,
        done: false
      }, {
        id: "t9",
        name: "cut WIP to ≤2 in-flight",
        impact: 8,
        effort: 3,
        done: false
      }, {
        id: "t10",
        name: "automate release pipeline",
        impact: 7,
        effort: 6,
        done: true
      }]
    ...
    children: [{
      id: "body.str",
      name: "strength",
      description: "lifts more than last quarter, never less.",
      weight: 30,
      children: [],
      tasks: [{
        id: "t11",
        name: "bench 1.25× bodyweight",
        impact: 9,
        effort: 8,
        done: false
      }, {
      ...
      id: "body.cardio",
      name: "endurance",
      description: "zone-2 base. can run an hour without thinking.",
      weight: 28,
      children: [],
      tasks: [{
        id: "t13",
      ...
      id: "body.rec",
      name: "recovery",
      description: "sleeps deep. mobility maintained.",
      weight: 42,
      children: [],
      tasks: [{
        id: "t15",
        name: "7.5h sleep avg, 30 days",
        impact: 10,
        effort: 7,
        done: false
      }, {
        id: "t16",
        name: "mobility 10 min daily",
        impact: 6,
        effort: 2,
        done: false
      }, {
    ...
    children: [{
      id: "mind.read",
      name: "deep_reader",
      description: "one book per fortnight. notes that survive.",
      weight: 40,
      children: [],
      tasks: [{
        id: "t18",
        name: "1 book / 2 weeks (Q-end)",
        impact: 8,
        effort: 5,
        done: false
      }, {
        id: "t19",
        name: "commonplace book habit",
        impact: 7,
        effort: 3,
        done: true
      }]
      ...
      id: "mind.still",
      name: "stillness",
      description: "quiet inside. not reactive.",
      weight: 35,
      children: [],
      tasks: [{
        id: "t20",
        name: "meditate 5×/week",
        impact: 9,
        effort: 4,
        done: false
      }, {
      ...
      id: "mind.refl",
      name: "reflective",
      description: "metabolizes own experience. weekly review.",
      weight: 25,
      children: [],
      tasks: [{
        id: "t22",
        name: "weekly review (sun pm)",
        impact: 7,
        effort: 2,
        done: true
      }, {
    ...
    children: [{
      id: "bond.partner",
      name: "partner",
      description: "first priority. attention, not residue.",
      weight: 45,
      children: [],
      tasks: [{
        id: "t24",
      ...
      id: "bond.fam",
      name: "family",
      description: "shows up. consistent across distance.",
      weight: 25,
      children: [],
      tasks: [{
        id: "t26",
      ...
      id: "bond.friends",
      name: "friends",
      description: "few, deep. invests time, not pings.",
      weight: 30,
      children: [],
      tasks: [{
        id: "t28",
        name: "host monthly dinner",
        impact: 9,
        effort: 6,
        done: false
      }, {
        id: "t29",
        name: "1 deep convo / week",
        impact: 8,
        effort: 3,
        done: true
      }]
...
function bottlenecks(root, n = 5) {
  ...
  return all.filter(({
    ...
    ...x,
    progress: progressOf(x.node),
    gap: x.weight * (1 - progressOf(x.node))
  })).filter(x => x.gap > 0.001).sort((a, b) => b.gap - a.gap).slice(0, n);
}
